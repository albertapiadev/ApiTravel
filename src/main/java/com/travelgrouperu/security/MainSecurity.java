package com.travelgrouperu.security;

import com.travelgrouperu.security.jwt.JwtEntryPoint;
import com.travelgrouperu.security.jwt.JwtTokenFilter;
import com.travelgrouperu.security.service.UserDetailsServiceImpl;
...
public class MainSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().and().csrf().disable()
                ...
                .antMatchers("/detalleCompra/**").permitAll()
                .antMatchers("/vuelo/**").permitAll()
